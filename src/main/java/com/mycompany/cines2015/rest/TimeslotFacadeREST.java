 ...
 */
package com.mycompany.cines2015.rest;

import com.mycompany.cines2015.entities.Timeslot;
...
@Stateless
@Named
@Path("com.mycompany.cines2015.timeslot")
public class TimeslotFacadeREST extends AbstractFacade<Timeslot> {

    @PersistenceContext(unitName = "com.mycompany_cines2015_war_1.0-SNAPSHOTPU")
